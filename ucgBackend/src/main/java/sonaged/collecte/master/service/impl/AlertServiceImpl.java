...
import sonaged.collecte.master.service.ImageService;
...
public class AlertServiceImpl implements AlertService {
    ...
    public List<Alert> readAllAlert() {
        var alertList = alertRepository.findByDeletionStatus(sonaged.collecte.master.enums.DeletionStatus.ACTIVE);
    ...
    public Page<Alert> readAllAlert(Pageable pageable){
        return alertRepository.findByDeletionStatus (sonaged.collecte.master.enums.DeletionStatus.ACTIVE, pageable).map (AlertMapper.AMP::asDto);
    }
    ...
    private Alert publishRaised(AlertEntity savedAlert) {
        ...
        eventPublisher.publishEvent(AlertRaisedEvent.manual(dto));
        return dto;
    }
}
