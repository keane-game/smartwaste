...
export class DepartmentComponent {
  ...
  constructor(
    ...
    ngOnInit() {
      this.sharedService.url = '/departments/all';
  ...
  //   .currentUser = this.departs.filter((item: any)=>item.userId == id)[0];
  //  // console.log(this.users, id);
  // }
  OpenUpdateDepartModal(arg0: any) {
  ...
  onDeleteUser(id: number): void{
    console.log(id);
    this.sharedService.url = '/delete/department';
